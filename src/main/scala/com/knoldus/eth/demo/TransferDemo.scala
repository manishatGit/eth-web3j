...
import com.knoldus.eth.factory.{ElasticClientFactory, Web3ClientFactory}
...
import com.knoldus.eth.util.PimpMyTransactions.TransactionReceiptFormatter
...
object TransferDemo extends App {
  ...
  val credentials: Credentials = WalletUtils.loadCredentials("rops@12er", WALLET_SOURCE)
  ...
  val transactionReceipt: TransactionReceipt = transferService.transferEther(web3j, credentials, ACCOUNT_TO, BigDecimal.valueOf(0.000001))
